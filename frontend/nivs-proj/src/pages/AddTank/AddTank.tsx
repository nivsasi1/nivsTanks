...
export const AddTank: React.FC = () => {
    ...
    const onSubmit: SubmitHandler<Input> = (data) => console.log(JSON.stringify(data) + alignment)
    ...
    return (
        ...
        <Box className="addtank">
                <Typography  variant="h2" mb="2rem">הוספת כלי</Typography>
                <Paper 
                sx={{ width: 1/2, mr:"auto" , ml:"auto"}}
                elevation={3} 
                style={{backgroundColor:'#F0F3FFa0', borderRadius:"1rem", padding: '7.5rem 12rem'}}>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <Typography variant="h6" style={{textAlign:"right"}}>פרטים</Typography>
                        <TextField
                        {...register("carNumber", { required:{ value: true, message:"נא הכנס מספר רכב"} })} 
                        id="carNumber"
                        name="carNumber"
                        label="מספר רכב (צ׳)"
                        fullWidth
                        ...
                        <Stack direction="row" spacing={2} my={2}>
                            <TextField
                            {...register("makat", { required:{ value: true, message:"נא הכנס מקט"} })} 
                            id="makat"
                            name="makat"
                            label="מקט"
                            type="number"
                            ...
                            />
                            <TextField
                            {...register("gdud", { required:{ value: true, message:"נא הכנס מספר גדוד"} })} 
                            id="gdud"
                            name="gdud"
                            label="מספר גדוד"
                            sx={{width:1/2}}
                            ...
                            color="secondary"
                            focused
                            error={errors.gdud?.message!=null && errors.gdud?.message.length > 0}
                            helperText={errors.gdud?.message}
                            />
                        </Stack>                            
                        <Typography variant="h6" style={{textAlign:"right"}}>כשירות רכב</Typography>
